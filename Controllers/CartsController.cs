...
namespace MiniWS.Controllers
{
    public class CartsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CartId,ProductId,UnitPrice,Quantity,Discount")] Cart cart)
        {
        ...
        {
            var c = db.Carts.Include(it => it.CartItem.Select(p => p.Product)).FirstOrDefault(it => it.CartId == id);
